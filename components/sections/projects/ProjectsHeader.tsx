// components/sections/projects/ProjectsHeader.tsx
  ...
  return (
    ...
    >
      <div className="max-w-2xl">
        ...
        >
          Explore full-stack web applications, enterprise systems, and
          digital experiences built with React, Next.js, TypeScript, Node.js,
          NestJS, and modern web technologies.
        </motion.p>
      </div>
    </motion.div>
  );
